...
CREATE TABLE `legacy` (
  ...
  PRIMARY KEY (`id`),
  KEY `ix_legacy_user` (`user`),
  KEY `ix_legacy_parent` (`parent`)
...
CREATE TABLE `posts` (
  ...
  `score` int(11) NOT NULL,
  PRIMARY KEY (`link`,`id`),
  KEY `ix_posts_user` (`user`),
  KEY `ix_posts_parent` (`parent`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2018-11-15 22:54:16
